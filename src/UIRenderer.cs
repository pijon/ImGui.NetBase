...
public class UIRenderer : IDisposable
{
    ...
    public UIRenderer(GraphicsDevice gd, OutputDescription outputDescription, int width, int height, float dpiScale)
        : this(gd, outputDescription, width, height, ColorSpaceHandling.Legacy, dpiScale) { }
    ...
    public UIRenderer(GraphicsDevice gd, OutputDescription outputDescription, int width, int height, ColorSpaceHandling colorSpaceHandling, float dpiScale)
    {
        _gd = gd;
        _assembly = typeof(UIRenderer).GetTypeInfo().Assembly;
    ...
    public void CreateDeviceResources(GraphicsDevice gd, OutputDescription outputDescription, ColorSpaceHandling colorSpaceHandling)
    {
        ...
        SamplerDescription linearSamplerDescription = new SamplerDescription
        {
        ...
        _fontSampler = gd.ResourceFactory.CreateSampler(linearSamplerDescription);
    ...
    public IntPtr GetOrCreateImGuiBinding(ResourceFactory factory, TextureView textureView)
    {
        if (!_setsByView.TryGetValue(textureView, out ResourceSetInfo rsi))
        {
            ResourceSet resourceSet = factory.CreateResourceSet(
                new ResourceSetDescription(_textureLayout, textureView, _gd.PointSampler));
    ...
    private static string s_baseShaderResourcePath = typeof(UIRenderer).Assembly.GetName().Name + ".Resources.Shaders.";
        ...
        ColorSpaceHandling colorSpaceHandling)
    {
        switch (factory.BackendType)
        {
            case GraphicsBackend.Direct3D11:
                {
                    ...
                    string resourceName = s_baseShaderResourcePath + "HLSL." + name + ".hlsl.bytes";
                    return GetEmbeddedResourceBytes(resourceName);
                }
            case GraphicsBackend.OpenGL:
                {
                    if (stage == ShaderStages.Vertex && colorSpaceHandling == ColorSpaceHandling.Legacy) { name += "-legacy"; }
                    string resourceName = s_baseShaderResourcePath + name + ".glsl";
                    return GetEmbeddedResourceBytes(resourceName);
                }
            ...
            case GraphicsBackend.Metal:
                {
                    string resourceName = s_baseShaderResourcePath + "Metal." + name + ".metallib";
                    return GetEmbeddedResourceBytes(resourceName);
                }
            default:
    ...
    public unsafe void RecreateFontDeviceTexture(GraphicsDevice gd)
    {
        ...
        _fontTextureResourceSet = gd.ResourceFactory.CreateResourceSet(new ResourceSetDescription(_textureLayout, _fontTexture, _fontSampler));
